...
<head>
	...
	<title>ICPNA - Programa para Niños</title>
    ...
    <meta name="twitter:title" content="ICPNA - MADEINICPNA">
    <meta name="twitter:description" content="Aprende Inglés y lleva todo tu talento al mundo.">
    <meta name="twitter:image" content="http://www.madeinicpna.pe/share-icpna.png">
			...
			<button class="nav-open">
 			...
 			<nav id="navigation" class="animated">
 				<ul>
 					...
 					<li>
 						<a href="programa-jovenes-adultos.php">PROGRAMA J&Oacute;VENES Y ADULTOS</a>
 					</li>
 					<li>
 						<a href="programa-ninos.php" class="act">PROGRAMA NI&Ntilde;OS</a>
 					</li>
 					<li>
